    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div class="reveal-group mx-auto max-w-2xl text-center">
            ...
            <p class="mt-6 text-lg leading-relaxed text-sand-100/70">
                <x-t>
                    <x-slot:es>Etapa 1 · 22 villas. Pasa el cursor o toca cada lote para ver su superficie y estado.</x-slot:es>
                    <x-slot:en>Stage 1 · 22 villas. Hover or tap any lot to see its area and status.</x-slot:en>
                </x-t>
            </p>
        </div>
                    ...
                    <template x-if="active">
                        <div class="py-2">
                            ...
                            <p class="mt-6 border-t border-sand-50/10 pt-6 text-sm text-sand-200/60" x-show="active && !active.m2">
                                <x-t><x-slot:es>Superficie disponible a solicitud.</x-slot:es><x-slot:en>Lot area available on request.</x-slot:en></x-t>
                            </p>
                            <a href="#contacto"
